...
export { default as Todo } from '../..\\components\\todo.vue'
...
export const LazyTodo = import('../..\\components\\todo.vue' /* webpackChunkName: "components/todo" */).then(c => wrapFunctional(c.default || c))
